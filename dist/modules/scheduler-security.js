...
var SchedulerSecurity = function () {
    function SchedulerSecurity(inputParams) {
    ...
    _createClass(SchedulerSecurity, [{
        ...
        value: function addJob(path) {
            ...
            var jobName = pathModule.basename(path);

            var spawn = require('child_process').spawn;

            var qsub = spawn("qsub", [path]);
        ...
        key: 'checkJob',
        value: function checkJob(name) {
            var spawn = require('child_process').spawn;

            var qstat = spawn("qstat", ['-f', '-j ' + name]);
...
exports.default = new SchedulerSecurity({
    maxReqPerSecUser: 2,
